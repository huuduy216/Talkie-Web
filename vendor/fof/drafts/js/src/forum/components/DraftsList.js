...
<<<<<<< HEAD
                                                      ...
                                                      title: app.translator.trans('fof-drafts.forum.dropdown.deleteAll_button'),
                                                      onclick: (e) => {
                                                        this.loading = true;
                                                        if (!window.confirm(app.translator.trans('fof-drafts.forum.dropdown.deleteAll_alert'))) return;
=======
                                                      ...
                                                      onclick: (e) => {
>>>>>>> parent of a152089...  Edit button position
                                                        var promise = [];
