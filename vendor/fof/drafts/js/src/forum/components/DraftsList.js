                ...
                promise.push(
                  draft.delete().then(() => {
                    if (
                      ...
                      app.composer.component.draft.id() ===
                        drafts[element].id() &&
              ...
              ? drafts
                  ...
                  .map((draft) => {
                    return (
                      <li>
                        <a
                          onclick={this.showComposer.bind(this, draft)}
                        ...
                        >
                          ...
                          {Button.component({
                            ...
                            className:
                              "Button Button--icon Button--link draft--delete draft--delete",
                          ...
                          app.forum.attribute("drafts.enableScheduledDrafts")
                            ? Button.component({
                                ...
                                style: "float: right; z-index: 20;",
                                className:
                                  "Button Button--icon Button--link draft--schedule",
                                title: app.translator.trans(
  ...
  showComposer(draft) {
    ...
    switch (draft.type()) {
      case "privateDiscussion":
        componentClass = require("@fof-byobu").components[
